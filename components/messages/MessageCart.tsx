  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center gap-y-6">
        {message.id === 7 || message.id === 11 ? <Image src={message.src!} alt="image" width={280} height={180} /> : null}
        ...
        {message.id === 14 || message.id === 19 ? <Image src={message.src} alt="image" width={280} height={280} /> : null}
      </div>
